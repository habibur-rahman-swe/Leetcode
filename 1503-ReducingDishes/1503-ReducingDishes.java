// Last updated: 10/20/2025, 11:39:17 AM
class Solution {
    ...
    int findMaxSatisfaction(int[] satisfaction, int[][] memo, int index, int time) {
        ...
        return memo[index][time] = Math.max(satisfaction[index] * time + findMaxSatisfaction(satisfaction, memo, index + 1, time + 1), findMaxSatisfaction(satisfaction, memo, index + 1, time));
    }
